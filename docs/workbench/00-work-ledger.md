...
| MOB-055 | 设置 → 报告错误 mailto 反馈通道 | REVIEW | Issue #153；真实 mailto 发送通道已落地（hello@mira.io，白名单诊断，无新协议/依赖）；开发机 typecheck/lint/jest 通过；真机人工验收按 [MOB-055 卡](../task-cards/MOB-055-report-error-feedback-mailto.md) 用例 1–9 |
